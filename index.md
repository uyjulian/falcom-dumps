...
You can use the GLTF/GLB import functionality and the FBX export functionality of Blender, which is a free 3D program: https://www.blender.org/  
...
Please see the following page for a visual of the texture inspector window: https://docs.unity3d.com/Manual/class-TextureImporter.html  
...
In this case, please use the following script to "bake" the bone positions so that it is offset from the first keyframe: https://gist.github.com/uyjulian/526c8c7326b0bd7031875c5973144000  
...
The following [QuickBMS](http://aluigi.altervista.org/quickbms.htm) script can be used for this purpose: http://aluigi.altervista.org/bms/legend_of_heroes.bms  

A Python script is also available for .pkg extraction: https://gist.github.com/uyjulian/55475c98c631632ddfd5453469726439  
...
The following [Noesis](https://richwhitehouse.com/index.php?content=inc_projects.php&showproject=91) script can be used for this purpose: https://zenhax.com/viewtopic.php?f=7&t=7573  

## How do I get the model data out of the .pkg file?
The following program can be used for this purpose: https://github.com/uyjulian/ed8pkg2glb  
...
Sen1+2 Character models, textures, and animations (GLB/GLTF binary combined format): https://mega.nz/file/psJHBAiT#GZ7RrqN_VewHKRI7ZIDsxU34XnOLMOZxUzM6msSEwog  

Sen3+4+Hajimari Character models, textures, and animations (GLB/GLTF binary combined format): https://mega.nz/file/xhBxlCqJ#TEE4Q3NsrWC98WJ35AYzdm4YnhqRPCpIPybrHFvr5MM  
...
WIP 3D model extracted: https://mega.nz/file/gsJ1HSpK#l8DLSA1e2cau0UGdlK83hMwNiwTBguBmHFWM77zMZz8  
